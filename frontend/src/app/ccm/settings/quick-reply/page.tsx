...
import { Card, MockTable, Pill, SettingRow, Toggle, MockBadge } from '@/components/ccm/ui';
    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <Card title="Chức năng & công cụ">
          <SettingRow title="Gợi ý mẫu trả lời nhanh" desc="Nhập / + ký tự tắt (vd /Ccm) sẽ gợi ý câu trả lời" control={<Toggle on />} />
